...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres://localhost/endossier'),
}
...
TENANT_MODEL = "customers.Customer" # app.Model
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = 'endossier.users.adapters.AccountAdapter'
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = 'endossier.users.adapters.SocialAccountAdapter'
